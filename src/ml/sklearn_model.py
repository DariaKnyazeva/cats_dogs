...
from .sklearn_utils import HogTransformer, RGB2GrayTransformer
...
class SKLinearImageModel(BaseModel):
    ...
    def load(self, source: str) -> SGDClassifier:
        try:
...
class ImageModelOptimiser:
    ...
    def __init__(self, model: SKLinearImageModel) -> None:
    ...
    def optimize(self, X: np.ndarray, y: np.ndarray) -> SKLinearImageModel:
        """
